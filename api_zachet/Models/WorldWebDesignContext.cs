...
public partial class WorldWebDesignContext : DbContext
{
    public WorldWebDesignContext()
    {
    }

    public WorldWebDesignContext(DbContextOptions<WorldWebDesignContext> options)
        : base(options)
    {
    }
